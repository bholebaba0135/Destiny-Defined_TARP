...
##### 1. Paper Title: Route recommendation system to support multiple destinations and multiple routes to minimise road congestion
The algorithm generates multiple near-optimal routes to destinations and efficiently distributes traffic based on costs to reduce congestion on the road network and service points. Real-life traffic data on actual city road networks were simulated to demonstrate the effectiveness of the proposed algorithm over conventional routing.
