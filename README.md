...
##### 4. Paper title : A multi-objective time-dependent route planner: a real world application to Milano city.
...
##### 5. Paper title : RouteMe: A Mobile Recommender System for Personalized, Multi-Modal Route Planning.    
...
##### 6. Paper title : Designing a route planner to facilitate and promote cycling in Metro Vancouver,Canada
